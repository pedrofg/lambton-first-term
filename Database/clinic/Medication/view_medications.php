...
$table = "";
if ($result = $conn->query('SELECT * FROM medication order by id desc;')) {
	...
	$table .= "<body>";
		...
		while ($row = $result->fetch_assoc()) {
			...
			<form action='delete_medication.php' method='post' >
				<input type='hidden' name='delete_medication_id' value='$row[id]'>
				<button id='delete-medication' type='submit' name='btn_delete' class='btn btn-danger'>Delete</button>
			</form>
			</td>";
			$table .= "</tr>";
		}
